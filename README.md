...
A local, **unpublished** visual refinement follows the bilingual release. It preserves the green educational identity and the existing workflow while replacing repeated rounded panels with a continuous reading surface, a single lesson-sheet preview and margin-style observations. Headings use locally available serif fonts; body text and controls use a restrained sans-serif hierarchy. No external font, image, animation library or network service was added. The live Pages site remains the previously published version until a new publication is explicitly authorized.
...
This candidate's demo-input SHA-256 is `36b044b00a2859030f6d2fb7ccec758082f9a6f117154af37d3207d4f75aba8f` at public base `8184681e3ae4d2463a52147b362870ba247c2c59`, with uncommitted changes. [Current visual captures](docs/showcase/README.md#visual-refinement-candidate--2026-09-22) show the comparison and verified states. Run the existing static preview instructions in [Operations](docs/OPERATIONS.md) to inspect the normal candidate.
